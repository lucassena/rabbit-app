...
export function Habit () {
    ...
    const habitsProgress = dayInfo?.habits.length ? generateProgressPercentage(dayInfo.habits.length, completedHabits.length) : 0;
    ...
    return (
        <View className="flex-1 bg-background px-8 pt-16">
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{paddingBottom: 30}}>
                ...
                <View className={clsx("mt-6", { 'opacity-40': isDateInPast })}>
                    {
                        dayInfo?.habits ?
